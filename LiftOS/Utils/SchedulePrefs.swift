...
struct SchedulePrefs { @AppStorage("scheduleMode") var mode: ScheduleMode = .fixedWeekdays; @AppStorage("daysPerWeek") var daysPerWeek: Int = 3; @AppStorage("currentWeek") var currentWeek: Int = 1; @AppStorage("currentDayIx") var currentDayIx: Int = 0 }
